...
export const CHALLENGES = {
  flam: [
    ...
    },
    {
      ...
      type: 'slalom',
      name: "Gudvangen Run",
      where: "7 gates, 2.6 km",
      blurb: "7 gates along 2.6 km of valley, 248 m of wall beside you.",
      needs: 25,
      marker: { lat: 60.7253, lon: 6.8336, agl: 365, heading: 284 },
      limit: 90,
      gates: [
        { name: "Gate 1", lat: 60.7253, lon: 6.8336, agl: 145, radius: 85 },
        { name: "Gate 2", lat: 60.7261, lon: 6.8265, agl: 130, radius: 85 },
        { name: "Gate 3", lat: 60.7262, lon: 6.8224, agl: 105, radius: 85 },
        { name: "Gate 4", lat: 60.7293, lon: 6.8182, agl: 90, radius: 85 },
        { name: "Gate 5", lat: 60.7312, lon: 6.8114, agl: 105, radius: 85 },
        { name: "Gate 6", lat: 60.7314, lon: 6.8036, agl: 110, radius: 85 },
        { name: "Gate 7", lat: 60.7325, lon: 6.7966, agl: 95, radius: 85 },
      ],
      medals: [83, 70, 60],
    },
  ],
  ...
  maui: [
    ...
    },
    {
      ...
      type: 'slalom',
      name: "Wailuku Run",
      where: "7 gates, 3.1 km",
      blurb: "7 gates along 3.1 km of valley, 215 m of wall beside you.",
      needs: 7,
      marker: { lat: 20.9026, lon: -156.494, agl: 340, heading: 245 },
      limit: 90,
      gates: [
        { name: "Gate 1", lat: 20.9026, lon: -156.494, agl: 120, radius: 85 },
        { name: "Gate 2", lat: 20.9007, lon: -156.4984, agl: 120, radius: 85 },
        { name: "Gate 3", lat: 20.8969, lon: -156.5012, agl: 110, radius: 85 },
        { name: "Gate 4", lat: 20.8939, lon: -156.505, agl: 115, radius: 85 },
        { name: "Gate 5", lat: 20.8909, lon: -156.5088, agl: 105, radius: 85 },
        { name: "Gate 6", lat: 20.8876, lon: -156.5124, agl: 100, radius: 85 },
        { name: "Gate 7", lat: 20.8847, lon: -156.5156, agl: 100, radius: 85 },
      ],
      medals: [89, 78, 67],
    },
    {
      id: 'pu-u-ula-ula-run-2',
      type: 'slalom',
      name: "Puʻuʻulaʻula Run",
      where: "7 gates, 3.1 km",
      blurb: "7 gates along 3.1 km of valley, 161 m of wall beside you.",
      needs: 24,
      marker: { lat: 20.7051, lon: -156.3444, agl: 300, heading: 27 },
      limit: 90,
      gates: [
        { name: "Gate 1", lat: 20.7051, lon: -156.3444, agl: 80, radius: 85 },
        { name: "Gate 2", lat: 20.7089, lon: -156.3424, agl: 95, radius: 85 },
        { name: "Gate 3", lat: 20.7131, lon: -156.3411, agl: 110, radius: 85 },
        { name: "Gate 4", lat: 20.7169, lon: -156.3392, agl: 110, radius: 85 },
        { name: "Gate 5", lat: 20.7212, lon: -156.3397, agl: 110, radius: 85 },
        { name: "Gate 6", lat: 20.725, lon: -156.3387, agl: 120, radius: 85 },
        { name: "Gate 7", lat: 20.7293, lon: -156.3393, agl: 145, radius: 85 },
      ],
      medals: [89, 85, 73],
    },
  ],
  jungfrau: [
    ...
    },
    {
      ...
      type: 'slalom',
      name: "Wilderswil Run",
      where: "7 gates, 2.9 km",
      blurb: "7 gates along 2.9 km of valley, 408 m of wall beside you.",
      needs: 17,
      marker: { lat: 46.6531, lon: 7.8532, agl: 395, heading: 220 },
      limit: 90,
      gates: [
        { name: "Gate 1", lat: 46.6531, lon: 7.8532, agl: 175, radius: 85 },
        { name: "Gate 2", lat: 46.6501, lon: 7.8496, agl: 155, radius: 85 },
        { name: "Gate 3", lat: 46.6468, lon: 7.8471, agl: 130, radius: 85 },
        { name: "Gate 4", lat: 46.6436, lon: 7.843, agl: 105, radius: 85 },
        { name: "Gate 5", lat: 46.6402, lon: 7.8394, agl: 105, radius: 85 },
        { name: "Gate 6", lat: 46.637, lon: 7.8352, agl: 110, radius: 85 },
        { name: "Gate 7", lat: 46.6364, lon: 7.8312, agl: 105, radius: 85 },
      ],
      medals: [85, 72, 62],
    },
    {
      id: 'schwarzhorn-run-2',
      type: 'slalom',
      name: "Schwarzhorn Run",
      where: "7 gates, 3.0 km",
      blurb: "7 gates along 3.0 km of valley, 387 m of wall beside you.",
      needs: 21,
      marker: { lat: 46.7396, lon: 8.0954, agl: 330, heading: 247 },
      limit: 90,
      gates: [
        { name: "Gate 1", lat: 46.7396, lon: 8.0954, agl: 110, radius: 85 },
        { name: "Gate 2", lat: 46.738, lon: 8.0897, agl: 110, radius: 85 },
        { name: "Gate 3", lat: 46.7372, lon: 8.0834, agl: 110, radius: 85 },
        { name: "Gate 4", lat: 46.7376, lon: 8.077, agl: 110, radius: 85 },
        { name: "Gate 5", lat: 46.7382, lon: 8.0706, agl: 105, radius: 85 },
        { name: "Gate 6", lat: 46.7394, lon: 8.0645, agl: 115, radius: 85 },
        { name: "Gate 7", lat: 46.7391, lon: 8.0586, agl: 115, radius: 85 },
      ],
      medals: [89, 76, 66],
    },
    {
      ...
      type: 'slalom',
      name: "Thunersee Run",
      where: "7 gates, 2.4 km",
      blurb: "7 gates along 2.4 km of valley, 144 m of wall beside you.",
      needs: 34,
      marker: { lat: 46.6708, lon: 7.7023, agl: 350, heading: 119 },
      limit: 90,
      gates: [
        { name: "Gate 1", lat: 46.6708, lon: 7.7023, agl: 130, radius: 85 },
        { name: "Gate 2", lat: 46.6691, lon: 7.7068, agl: 115, radius: 85 },
        { name: "Gate 3", lat: 46.6676, lon: 7.7114, agl: 105, radius: 85 },
        { name: "Gate 4", lat: 46.6651, lon: 7.7152, agl: 120, radius: 85 },
        { name: "Gate 5", lat: 46.6624, lon: 7.7184, agl: 105, radius: 85 },
        { name: "Gate 6", lat: 46.6619, lon: 7.7234, agl: 90, radius: 85 },
        { name: "Gate 7", lat: 46.6625, lon: 7.7263, agl: 120, radius: 85 },
      ],
      medals: [76, 64, 55],
    },
  ],
